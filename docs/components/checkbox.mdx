...
| flexDirection | string  | 'row'         | Maybe you need the checkbox to be on top of an image? You can do that with this prop.                 |
...
| onChange      | function| () => {}      | This prop takes an arrow function and every time the user presses the checkbox the function is called.|
