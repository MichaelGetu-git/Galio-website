...
- importa { theme, withGalio, GalioProvider } from 'galio-framework'
- exporta default withGalio(TuComponente, estilosDelComponente);
...
const { height, width } = Dimensions.get('screen'); Por defecto se usa el tamaño de 16 para calcular todos los tamaños
