    ...
    return (
        <div className="relative w-full h-130 md:h-200 overflow-hidden bg-white -top-25 md:-top-40">
            ...
            <div className="absolute inset-0 flex flex-col lg:items-start justify-center left-7 md:left-24 lg:left-38 top-100 md:top-100 lg:top-18 text-black font-light text-xl md:text-3xl lg:text-5xl z-10">
                ...
                <span className="">+ more soon<br/></span> 
            </div>
            <div className="absolute inset-0 flex flex-col items-end justify-center right-28 md:right-58 lg:right-28 top-100 md:top-100 lg:top-22 text-black md:text-black lg:text-white font-light text-xl md:text-3xl lg:text-5xl z-10">
                <span className="font-semibold text-2xl md:text-5xl lg:text-6xl">60+<br/></span>
                <span>elements</span>
            </div>
